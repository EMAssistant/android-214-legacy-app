...
public class SvgPathBuilder {
    ...
    public String toString() {
        return "< path stroke-width=\"" + mStrokeWidth + "\" d=\"" + SVG_MOVE + mStartPoint + mStringBuilder.toString() + "\">";
    }
    ...
    private String makeRelativeCubicBezierCurve(final SvgPoint controlPoint1, final SvgPoint controlPoint2, final SvgPoint endPoint) {
        ...
        // discard zero curve
        // TODO figure out what author was trying to do since that will never be true
